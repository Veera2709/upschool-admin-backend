                                                    ...
                                                    if (!duplicateLables.includes(workbook[i].data[j][0])) {
                                                        ...
                                                        if (!helper.isEmptyObject(category) || !helper.isEmptyObject(source) || !helper.isEmptyObject(congnitive)) {
                                                            ...
                                                            questionsData.push({
                                                                ...
                                                                appears_in: helper.prePostArray.includes(workbook[i].data[j]?.[4]) ? 'preOrPost' : helper.worksheetOrTestArray.includes(workbook[i].data[j][4]) ? 'worksheetOrTest' : ["preOrPost", "worksheetOrTest"],
